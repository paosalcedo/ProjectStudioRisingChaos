...
public class SceneStackManager<TTransitionData>
{
    ...
    // Along with the root we need to let the manager what scenes it will
    ...
    public SceneStackManager(GameObject root, IEnumerable<GameObject> scenePrefabs)
    {
        SceneRoot = root;
